...
$(document).ready(function () {
    ...
    // click listener to toggle action item as complete
    $('.outPut').on('click', '.toggleComplete', markAsComplete);
    ...
    for (let i = 0; i < response.length; i++) {
        let newRow = $(`
            ...
            <div id="icons">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" id="${response[i].isComplete}" data-id="${response[i].id}" class="toggleComplete" viewBox="0 0 16 16">
